...
<body class="d-flex h-100 text-center text-bg-dark">
    ...
    <?php
        ...
        include("sendblob.php");
        
        include("send-recording-modal.php");
        $infant_id = $_SESSION['infant_id'];
    ?>
    <script>
      var infant_id = "<?php echo $infant_id; ?>";
    </script>
...
<header class="mb-auto">
  <div class="d-flex align-items-center">
    ...
    <nav class="nav nav-masthead ms-auto">
      <a class="nav-link fw-bold py-1 px-0 active" aria-current="page" href="#">Home</a>
      <a href="logout.php" class="nav-link fw-bold py-1 px-0" href="#">Log Out</a>
    </nav>
  </div>
</header>
  ...
  <main class="px-3">
                ...
                <p class="lead">
                    <div class = "buttons">
                        ...
                        <button id="pause" type="button" class="btn btn-secondary btn-lg">PAUSE</button>
                ...
                <div class="parent-container">
                      <!-- from show-played-recordings.php -->
                      ...
                      <br><br>
                      <div>
                      <?php include('parent-message-nav.php');?>
                      </div>
                </p>
              </main>

  <footer class="mt-auto text-white-50">
    <p>Designed by CS23-326 for VCU Health</p>
  </footer>
</div>
